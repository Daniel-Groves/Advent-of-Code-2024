...
for pair in antenna_loc_pairs:
    ...
    # calulcate antinode positions
    antinode_1 = [antenna_loc[0] - (antenna_loc2[0] - antenna_loc[0]), antenna_loc[1] - (antenna_loc2[1] - antenna_loc[1])]
    antinode_2 = [antenna_loc2[0] - (antenna_loc[0] - antenna_loc2[0]), antenna_loc2[1] - (antenna_loc[1] - antenna_loc2[1])]
